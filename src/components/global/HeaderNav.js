...
const HeaderNav = () => (
  <div class="header">
    ...
    <a class="logo" title="Deep Design Agency London" href="/"></a>
          ...
          <nav id="main-navigation">
            <ul id="menu-main-navigation" class="menu">
              <li id="menu-item-16" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-16"><a
                href="http://www.deep.co.uk/about/">Manifesto</a></li>

              <li id="menu-item-17" class="menu-item menu-item-type-post_type menu-item-object-page first menu-item-17">
                <a href="http://www.deep.co.uk/projects/">Projects</a></li>
              <li id="menu-item-191" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-191"><a
                href="http://www.deep.co.uk/people/">Peeps</a></li>
              <li id="menu-item-542" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-542"><a
                href="http://www.deep.co.uk/edit/">Artists</a></li>
              <li id="menu-item-542" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-542"><a
                href="http://www.deep.co.uk/edit/">Records</a></li>

              <li id="menu-item-542" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-542"><a
                href="http://www.deep.co.uk/edit/">Shop</a></li>

              <li id="menu-item-14" class="menu-item menu-item-type-post_type menu-item-object-page last menu-item-14">
                <a href="http://www.deep.co.uk/contact/">Contact</a></li>
            </ul>
          </nav>
          <ul id="main-contact" class="tfc p3 f14">
            <li>
              <a class="underlined underlined-ffc" href="mailto:will@onlyhysterical.com">Email.</a>
            </li>
            <li class="ffc">
              <a href="tel:+447415421853">
                +447415421853.</a>
            </li>
          </ul>
        </div>
...
//       <Link to="/styles">Records</Link>
//       <Link to="/styles">Rooster</Link>
//     </nav>
